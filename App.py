...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='12345',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://resume.io/" style="text-decoration: none; color: #fffff;">Aditya</a></b>'
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            ...
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>12345</b> as password.<br/>
            It will load all the required stuffs and perform analysis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <a href="" style="text-decoration: none; color: grey;">Aditya</a> 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == '12345':
                ...
                st.success("Welcome Adi ! Total %d " % values + " User's Have Used Our Tool : )")
